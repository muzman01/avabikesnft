  ...
  return (
    <section className="container">
      <div className="team">
        ...
        <div className="line">
          <div className="img">
            <Image src={hodor} height={280} width={200} data-aos="flip-down"data-aos-duration="2000"/>
            <Image src={coinlos} height={280} width={200}  data-aos="flip-up"/>
            <Image src={chef} height={280} width={200} data-aos="flip-down"  data-aos-duration="2000" />
            <Image src={musa} height={280} width={200} data-aos="flip-up" />
            <Image src={ninja} height={280} width={200}data-aos="flip-down" data-aos-duration="2000" />
          </div>
        </div>
      </div>
    </section>
